    ...
    internal static class SourceGeneratorHelper
    {
        ...
        internal static ServiceInfo GetServiceInfo(GeneratorAttributeSyntaxContext context)
        {
            ...
            return new ServiceInfo
            {
                ...
                Namespace = arguments.GetValueOrDefault(nameof(InjectServiceAttribute.CollectionNamespace))?.ToString(),
                ...
                ImplementationName = GetImplementationName(
                    symbol,
                    arguments.GetValueOrDefault(nameof(InjectServiceAttribute.ImplementationOf))?.ToString(),
                    injectAlone
                ),
                Key = arguments.GetValueOrDefault(nameof(InjectServiceAttribute.Key))
            };
        }
